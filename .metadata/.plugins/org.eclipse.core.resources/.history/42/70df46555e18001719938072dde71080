...
<!--HEADER-->
 <div class="header_top_bg">
                ...
                <div class="col-sm-4 header_account_reponsive">
                    <div class="header_top_account pull-right">
						...
						<li class="check_order">
									<a href="#" class="check_order_link">Kiểm tra đơn hàng</a>
								</li>
							<li class="personal-setting"><a
								href="${pageContext.request.contextPath }/profile"
								class="personal-profile">Chào
									${pageContext.request.userPrincipal.name}</a></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle user_avat_toggle"
                        ...
                        <div class="header_login_top pull-right">
                            <a href="${pageContext.request.contextPath}/login" class="header_login_link"><i class="fa fa-lock"></i>Đăng nhập/Đăng ký</a>
                        </div>
                         <div class="header_login pull-right">
                            <a href="#" class="header_login_link"><i class="fa fa-user"></i>Tài khoản của tôi</a>
                        </div>
                    </div>
						</c:if>
					</ul>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="header_logo">
                           <a href="${pageContext.request.contextPath }/home"><img src="${pageContext.request.contextPath }/resource/images/logo/int-logo.png"></a>
                        </div>
                    </div>
                    <div class="col-sm-6">
    ...
    <div class="container">
    <div class="row">
     <div class="col-sm-4" id="cart_toggle">
         <div class="main-content-cart">
        <div class="container">
            <div class="row">
            <div class="col-sm-4"></div>
                <div class="col-sm-4">
                <ul class="cart_menu_main">
               <li class="cart_menu_toggle">
                  <span class="item">
   ...
   <div class="header_menu_bg">
       <div class="container no-padding">
           <div class="main_menu_bg">
               ...
               <div class="main_menu_item">
                   <a href="#" class="main_menu_item_link">Công nghệ<span class="laptop_item">Laptop</span></a>
               </div>
                <div class="main_menu_item" id="main_menu" >
                   <a href="#" class="main_menu_item_link">Thời trang<span class="fashion_item">Thời trang</span></a>
                    <div class="sub_menu_bg hidden-xs" id="show_main_menu">
                        <div class="sub_menu_col" >
                            <a href="#" class="sub_menu_col_title">Thời trang nam</a>
                            <a href="#" class="sub_menu_col_item"><span>Áo sơ mi nam</span></a>
                            <a href="#" class="sub_menu_col_item"><span>Áo thun nam</span></a>
                            <a href="#" class="sub_menu_col_item"><span>Áo body nam</span></a>
                            <a href="#" class="sub_menu_col_item"><span>Áo khoác nam</span></a>
                        </div> 
                          <div class="sub_menu_col" >
                            <a href="#" class="sub_menu_col_title">Thời trang nam</a>
                            <a href="#" class="sub_menu_col_item"><span>Áo sơ mi nam</span></a>
                ...
                <div class="main_menu_item">
                   <a href="#" class="main_menu_item_link">Đồng hồ<span class="watch_item">Đồng hồ</span></a>
               </div>
                <div class="main_menu_item" id="main_menu1">
                   <a href="#" class="main_menu_item_link">Giày dép<span class="shoe_item">Giày dép</span></a>
                ...
                <div class="main_menu_item">
                   <a href="#" class="main_menu_item_link">Sắc đẹp<span class="beauty_item">Sắc đẹp</span></a>
               </div>
                <div class="main_menu_item">
                   <a href="#" class="main_menu_item_link">Trang sức<span class="jewelry_item">Trang sức</span></a>
               </div>
                <div class="main_menu_item">
                   <a href="#" class="main_menu_item_link">Trẻ em<span class="child_item">Trẻ em</span></a>
               </div>
           </div>
       </div>
